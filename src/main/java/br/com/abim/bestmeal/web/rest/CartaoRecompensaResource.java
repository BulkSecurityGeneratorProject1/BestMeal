...
public class CartaoRecompensaResource {
    ...
    public ResponseEntity<CartaoRecompensa> createCartaoRecompensa(@RequestBody CartaoRecompensa cartaoRecompensa) throws URISyntaxException {
    ...
    public ResponseEntity<CartaoRecompensa> updateCartaoRecompensa(@RequestBody CartaoRecompensa cartaoRecompensa) throws URISyntaxException {
