...
public class MenuResourceIT {
    ...
    private static final Double DEFAULT_VALOR_NORMAL = 1D;
    private static final Double UPDATED_VALOR_NORMAL = 2D;

    private static final Double DEFAULT_TEMPO_PREPARO = 1D;
    private static final Double UPDATED_TEMPO_PREPARO = 2D;

    private static final Boolean DEFAULT_DISPONIVEL = false;
    private static final Boolean UPDATED_DISPONIVEL = true;

    private static final Double DEFAULT_VALOR_REDUZIDO = 1D;
    private static final Double UPDATED_VALOR_REDUZIDO = 2D;
    ...
    public void createMenu() throws Exception {
        ...
        assertThat(testMenu.isDisponivel()).isEqualTo(DEFAULT_DISPONIVEL);
    ...
    public void updateMenu() throws Exception {
        ...
        assertThat(testMenu.isDisponivel()).isEqualTo(UPDATED_DISPONIVEL);
